...
router.get("/", auth.requireLogin, function (req, res, next) {
    ...
    if (
        ["title", "category", "author", "created", "published"].indexOf(
            sortby
        ) === -1
    ) {
        sortby = "created";
...
router.get("/edit/:id", auth.requireLogin, getPostById, function (
    req,
    res,
    next
) {
...
router.post("/edit/:id", auth.requireLogin, getPostById, function (
    req,
    res,
    next
) {
